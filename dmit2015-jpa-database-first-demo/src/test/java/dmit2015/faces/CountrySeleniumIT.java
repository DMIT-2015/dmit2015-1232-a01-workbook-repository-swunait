...
//                driver.findElement(By.xpath("//a[aria-label='Next Page']")).click();
    ...
    @ParameterizedTest
    @CsvSource(value = {
            "countryId, AB, countryName, Alberta Canada, selectedRegionId, Americas (20)",
            "countryId, KR, countryName, South Korea, selectedRegionId, Asia (30)",
            "countryId, XE, countryName, X Earth, selectedRegionId, Europe (10)",
    })
    void shouldCreate(
    ...
    @ParameterizedTest
    @CsvSource({
            "editId,AB,countryName,New Alberta Canada,selectedRegionId,Oceania (40)",
            "editId,KR,countryName,New Korea,selectedRegionId,Africa (50)",
            "editId,XE,countryName,New Earth,selectedRegionId,Americas (20)",
    })
    void shouldEdit(
